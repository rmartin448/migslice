...
from .parser import extract, extract_range, list_ids
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if not args.list and not args.id and not args.from_id and not args.to_id:
        parser.error("an id, or --from/--to, is required unless --list is given")
